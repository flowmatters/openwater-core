...
var outputsFor = flag.String("outputs-for", "", "only write model outputs for specified models. Specify as comma separated list of model names")
var inputsFor = flag.String("inputs-for", "", "only write final model inputs for specified models. Specify as comma separated list of model names")
var noOutputsFor = flag.String("no-outputs-for", "", "do not write model outputs for specified models. Specify as comma separated list of model names")
var noInputsFor = flag.String("no-inputs-for", "", "do not write final model inputs for specified models. Specify as comma separated list of model names")
