 ...
 *
 * This file is generated by ow-specgen using metadata from models/rr/coeff.go
 * 
...
func (m *RunoffCoefficient) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *RunoffCoefficient) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *RunoffCoefficient) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
