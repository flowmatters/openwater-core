...
func (m *GR4J) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *GR4J) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *GR4J) InitialiseStates(n int) data.ND2[float64] {
...
func (m *GR4J) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
