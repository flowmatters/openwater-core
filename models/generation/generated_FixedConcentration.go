 ...
 *
 * This file is generated by ow-specgen using metadata from src/github.com/flowmatters/openwater-core/models/generation/fixed_concentration.go
 * 
 * Don't edit this file. Edit src/github.com/flowmatters/openwater-core/models/generation/fixed_concentration.go instead!
 */
import (
//  "fmt"
...
func (m *FixedConcentration) ApplyParameters(parameters data.ND2Float64) {
  ...
  m.concentration = parameters.Slice([]int{ 0, 0}, []int{ 1, nSets}, nil).MustReshape(newShape).(data.ND1Float64)
...
//  for i := 0; i < numCells; i++ {
  for j := 0; j < numCells; j++ {
    go func(i int){
      ...
      // fmt.Println("concentration=",m.concentration)
