...
func (m *FixedConcentration) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *FixedConcentration) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *FixedConcentration) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *FixedConcentration) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
