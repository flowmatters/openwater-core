 ...
 *
 * This file is generated by ow-specgen using metadata from models/generation/emc_dwc.go
 * 
 * Don't edit this file. Edit models/generation/emc_dwc.go instead!
 */
import (
//  "fmt"
...
func (m *EmcDwc) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *EmcDwc) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *EmcDwc) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *EmcDwc) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
