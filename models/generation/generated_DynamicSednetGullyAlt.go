...
func (m *DynamicSednetGullyAlt) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *DynamicSednetGullyAlt) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *DynamicSednetGullyAlt) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *DynamicSednetGullyAlt) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
