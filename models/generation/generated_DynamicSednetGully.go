  ...
  for j := 0; j < numCells; j++ {
    go func(i int){
      ...
      generatedcoarseSliced := generatedcoarse.Unroll()
       ...
       sednetGullyOrig(quickflow,year,annualrunoff,annualload,yeardisturbance,gullyendyear,area,averagegullyactivityfactor,gullyannualaveragesedimentsupply,gullypercentfine,managementpracticefactor,longtermrunofffactor,dailyrunoffpowerfactor,sdrfine,sdrcoarse,timestepinseconds,fineloadSliced,coarseloadSliced,generatedfineSliced,generatedcoarseSliced)
