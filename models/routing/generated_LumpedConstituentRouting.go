...
func (m *LumpedConstituentRouting) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *LumpedConstituentRouting) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *LumpedConstituentRouting) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *LumpedConstituentRouting) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
