...
func (m *ApplyScalingFactor) ApplyParameters(parameters data.ND2[float64]) {
  ...
  newShape = []int{ nSets}
    ...
    m.scale = parameters.Slice([]int{ paramIdx, 0}, []int{ paramSize, nSets}, nil).MustReshape(newShape).(data.ND1[float64]).Unroll()
...
func (m *ApplyScalingFactor) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *ApplyScalingFactor) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *ApplyScalingFactor) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
