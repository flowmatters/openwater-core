 ...
 *
 * This file is generated by ow-specgen using metadata from src/github.com/flowmatters/openwater-core/models/conversion/depthtorate.go
 * 
 * Don't edit this file. Edit src/github.com/flowmatters/openwater-core/models/conversion/depthtorate.go instead!
 */
import (
//  "fmt"
...
func (m *DepthToRate) InitialiseStates(n int) data.ND2Float64 {
  // Zero states
...
func (m *DepthToRate) Run(inputs data.ND3Float64, states data.ND2Float64, outputs data.ND3Float64) {
