 ...
 *
 * This file is generated by ow-specgen using metadata from models/conversion/depthtorate.go
 * 
 * Don't edit this file. Edit models/conversion/depthtorate.go instead!
 */
import (
//  "fmt"
...
func (m *DepthToRate) ApplyParameters(parameters data.ND2[float64]) {
...
func buildDepthToRate() sim.TimeSteppingModel {
	result := DepthToRate{}
	return &result
}

func init() {
	sim.Catalog["DepthToRate"] = buildDepthToRate
}
...
func (m *DepthToRate) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *DepthToRate) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *DepthToRate) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
