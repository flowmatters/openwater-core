...
func (m *DeliveryRatio) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *DeliveryRatio) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *DeliveryRatio) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *DeliveryRatio) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
