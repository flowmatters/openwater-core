...
func (m *RatingCurvePartition) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *RatingCurvePartition) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *RatingCurvePartition) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
  ...
  for j := 0; j < numCells; j++ {
    go func(i int){
      ...
      output2Sliced := output2.Unroll()
       ...
       ratingPartition(input,npts,inputamount,proportion,output1Sliced,output2Sliced)
