...
func (m *VariablePartition) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *VariablePartition) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *VariablePartition) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *VariablePartition) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
...
//  for i := 0; i < numCells; i++ {
  ...
  //    fmt.Println("{fraction <nil>}",tmpTS.Shape())
      ...
      output2Sliced := output2.Unroll()
       ...
       variablePartition(input,fraction,output1Sliced,output2Sliced)
