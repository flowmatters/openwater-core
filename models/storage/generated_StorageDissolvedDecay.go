...
func (m *StorageDissolvedDecay) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *StorageDissolvedDecay) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *StorageDissolvedDecay) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
