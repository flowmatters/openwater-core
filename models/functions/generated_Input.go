 ...
 *
 * This file is generated by ow-specgen using metadata from models/functions/input.go
 * 
 * Don't edit this file. Edit models/functions/input.go instead!
 */
import (
//  "fmt"
...
func (m *Input) ApplyParameters(parameters data.ND2[float64]) {
...
func buildInput() sim.TimeSteppingModel {
	result := Input{}
	return &result
}

func init() {
	sim.Catalog["Input"] = buildInput
}
...
func (m *Input) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *Input) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *Input) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
...
//	result.States = states  //clone? make([]sim.StateSet, len(states))
  ...
  // fmt.Println("Running Input for ",numCells,"cells")
