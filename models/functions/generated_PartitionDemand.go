 ...
 *
 * This file is generated by ow-specgen using metadata from src/github.com/flowmatters/openwater-core/models/functions/partition_demand.go
 * 
 * Don't edit this file. Edit src/github.com/flowmatters/openwater-core/models/functions/partition_demand.go instead!
 */
import (
//  "fmt"
...
func (m *PartitionDemand) InitialiseStates(n int) data.ND2Float64 {
  // Zero states
...
func (m *PartitionDemand) Run(inputs data.ND3Float64, states data.ND2Float64, outputs data.ND3Float64) {
...
//    fmt.Println("{demand <nil>}",tmpTS.Shape())
		demand := cellInputs.Slice([]int{ 1,0}, []int{ 1,inputLen}, nil).MustReshape(inputNewShape).(data.ND1Float64)
    ...
    extraction := outputs.Slice(outputPosSlice,outputSizeSlice,outputStepSlice).MustReshape([]int{inputLen}).(data.ND1Float64)
