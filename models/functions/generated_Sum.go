...
func (m *Sum) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *Sum) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *Sum) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *Sum) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
