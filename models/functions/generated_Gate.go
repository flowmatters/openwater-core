 ...
 *
 * This file is generated by ow-specgen using metadata from models/functions/gate.go
 * 
 * Don't edit this file. Edit models/functions/gate.go instead!
 */
import (
//  "fmt"
...
func (m *Gate) ApplyParameters(parameters data.ND2[float64]) {
...
func (m *Gate) FindDimensions(parameters data.ND2[float64]) []int {
...
func (m *Gate) InitialiseStates(n int) data.ND2[float64] {
  // Zero states
...
func (m *Gate) Run(inputs data.ND3[float64], states data.ND2[float64], outputs data.ND3[float64]) {
...
//  for i := 0; i < numCells; i++ {
  ...
  //    fmt.Println("{trigger <nil>}",tmpTS.Shape())
      trigger := cellInputs.Slice([]int{ 0,0}, []int{ 1,inputLen}, nil).MustReshape(inputNewShape).(data.ND1[float64])
      
  //    fmt.Println("{incoming <nil>}",tmpTS.Shape())
      incoming := cellInputs.Slice([]int{ 1,0}, []int{ 1,inputLen}, nil).MustReshape(inputNewShape).(data.ND1[float64])
      ...
      outgoing := outputs.Slice(outputPosSlice,outputSizeSlice,outputStepSlice).MustReshape([]int{inputLen}).(data.ND1[float64])
